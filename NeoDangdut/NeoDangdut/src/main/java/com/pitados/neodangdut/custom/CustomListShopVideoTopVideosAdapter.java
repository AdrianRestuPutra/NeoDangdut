 ...
 */
public class CustomListShopVideoTopVideosAdapter extends BaseAdapter {
    private Context context;
    private List<MusicData> listTopTrack; // TODO change to shop data

    public CustomListShopVideoTopVideosAdapter(Context context, List<MusicData> listTopTrack) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null) {
            view = inflater.inflate(R.layout.layout_list_top_track, null); // TODO change to shop top video
