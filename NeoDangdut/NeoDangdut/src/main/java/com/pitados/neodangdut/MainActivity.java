...
import com.pitados.neodangdut.CustomAdapters.CustomPagerAdapter;
...
//        });
        ...
        // CONTENT
        viewPager = (ViewPager) findViewById(R.id.pager_main_content);
        pagerAdapter = new CustomPagerAdapter(getSupportFragmentManager());
        viewPager.setAdapter(pagerAdapter);

        slidingTab = (TabLayout)findViewById(R.id.sliding_tab);
